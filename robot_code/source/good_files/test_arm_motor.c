...
//*********
	...
	printf("200 is ok. It should be less than 1060 (maxspeed):\n");
	scanf("%d",&speed);
	printf("input total run time (in s, can be float number). 4.5s is ok: \n");
	scanf("%f", &time_total);

	set_tacho_speed_sp( sn_arm, speed );
	set_tacho_time_sp( sn_arm, time_total*1000 );
