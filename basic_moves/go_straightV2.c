...
int go_straight(int port, uint8_t sn, int speed, int time_total, int time_ram_up, int time_ram_down){
...
int main( void )
{
	...
	printf("input the speed. It should be less than 1050 (maxspeed):\n");
	scanf("%d",&speed);
	...
	print("it is running:\n");
	go_straight(port_left,sn_left,speed,time_total,time_ram_up, time_ram_up);
	go_straight(port_right,sn_right,speed,time_total,time_ram_up, time_ram_up);
